    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.contacts}>
        <span className={styles.contact}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#b6924f" strokeWidth="1.5">
        ...
        <span className={styles.contact}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#b6924f" strokeWidth="1.6">
        ...
        <span className={styles.sep}>|</span>
        <span className={styles.contact}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="#b6924f">
        ...
        <span className={styles.sep}>|</span>
        <span className={styles.contact}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="#b6924f">
